...
const JobCard = ({ job }) => {
  ...
  return (
    <div className='border p-6 shadow rounded'>
        ...
        <p className='text-gray-500 text-small mt-4' dangerouslySetInnerHTML={{__html:job.description.slice(0,150)}}></p>
        <div className='mt-4 flex gap-4 text-sm'>
            ...
            <button onClick={() => {navigate(`/apply-job/${job._id}`);scrollTo(0,0)}} className='bg-gray-500 border border-gray-500 rounded px-4 py-2 '>Learn More</button>
        </div>
    </div>
  )
}
