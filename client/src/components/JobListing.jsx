...
const JobListing = () => {
    ...
    return (
        <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row gap-10 my-10'>
            {/* sidebar */}
            <div className='w-full lg:w-1/4 bg-white shadow-md rounded px-4'>
                {/* search filter from hero component */}
                {
                    isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
                        <>
                            <h3 className='font-medium text-large mb-4'>Current Search</h3>
            ...
            <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
                ...
                {filteredJobs.length > 0 && (
                    <div className='flex items-center justify-center mt-10 space-x-2'>
                        <a href="#job-list">
                            <img onClick={() => setCurrentPage(currentPage => Math.max(currentPage - 1, 1))}
                        ...
                        <a href="#job-list">
                            <img onClick={() => setCurrentPage(currentPage => Math.min(currentPage + 1, Math.ceil(filteredJobs.length / 6)))}
